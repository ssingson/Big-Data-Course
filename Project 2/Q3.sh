...
/usr/local/hadoop/bin/hdfs dfs -copyFromLocal training.csv /P2/Part3/input/
/usr/local/hadoop/bin/hdfs dfs -copyFromLocal test.csv /P2/Part3/input/
/usr/local/spark/bin/spark-submit --master=spark://$SPARK_MASTER:7077 Q3.py hdfs://$SPARK_MASTER:9000/P2/Part3/input/
../../stop.sh
